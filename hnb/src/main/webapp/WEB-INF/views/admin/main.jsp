			...
			alert("넘어온"+pageNo);
			 $.getJSON(context+'/admin/member_List/'+pageNo ,function(data) {
					...
					$.each(data.list,function(index,value){
						...
						+"<TD WIDTH=20% ALIGN=CENTER><A HREF='BoardContent.jsp'>"+value.name+"</A></TD>"
					...
					if (startPage-groupSize>0) {
						pagination +='<a href="'+context+'/admin/member_List/'
						+(startPage-groupSize)+'">'
					...
					+'<FORM NAME="memberSearch" action="'+context+'/admin/member_List/1">'
